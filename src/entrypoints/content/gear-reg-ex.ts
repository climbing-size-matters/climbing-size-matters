...
const GREEN_COLOR = 'rgb(0, 158, 58)';
const GREEN_000 =
...
const GREEN_075 =
    /#?0.75|1\.[1-3]\s?(in|")|(23\.[9]|2[4-9]\.[0-9]|3[0-9]\.[0-9]|40\.[0-9]|41\.[0-2])(?=\s?mm|")|(green|2)\s(dragon(?!fly)|dmm)|(mastercam)(\s5)|black\s((metolius)|(mc))|(green\stotem)|(green)\s(friend|wc)(\s0?.75)?/gi;
const GREEN_600 = /#6(\.0)?|(green)\s(friend)|wc(\s6)/gi;

const RED_COLOR = 'rgb(203, 27, 49)';
const RED_010 =
...
const RED_100 =
    /1\.[4-7]\s?(in|")|(35\.([7-9])?|(36|37|38|39|40|41|42|43)\.([0-9])?|44\.([0-6])?)(?=\s?mm|")|(red|3)\s(dragon|dmm)|(mastercam)(\s5)|green\s((metolius)|(mc))|(#?1(\.0)?|red)\s(totem|camalots?|c4|friend|wc)(\s1)?|#1(\.0)?(?! (metolius|master cam|mc))/gi;
const RED_700 = /#7(\.0)?/;

const YELLOW_COLOR = 'rgb(201, 175, 25)';
const YELLOW_020 =
    /#?0\.2|(0\.(4[0-7]|5|6|6[0-4])|0\.[46])\s?(in|")|((12\.[1-9])|(13(\.[0-9])?)|(14(\.[0-9])?)|(15(\.[0-0])?))(?=\s?mm)|(green\sc3)|yellow\s(z4|bd|cam(alot(s)?)?)|purple\s(metolius|mc)|(blue\salien)|(black\stotem)|(yellow|3)\sdragonfly/gi;
const YELLOW_200 =
...
const BLUE_COLOR = 'rgb(17, 119, 204)';
const BLUE_030 =
...
// const GRAY_COLOR = 'rgb(155, 161, 183)';
// const GRAY_040 =
...
// const PURPLE_COLOR = 'rgb(97, 79, 200)';
// const PURPLE_050 =
